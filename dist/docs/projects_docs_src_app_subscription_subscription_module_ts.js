...
FilterValueComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: FilterValueComponent, selectors: [["app-filter-value-dialog"]], decls: 30, vars: 10, consts: [["mat-dialog-title", ""], [3, "formGroup"], ["mat-dialog-content", ""], ["class", "type-tooltip-ne", "matTooltip", "Tooltip!", 4, "ngIf"], ["matInput", "", "tabindex", "1", "formControlName", "name", "id", "name", "type", "text", 1, "form-control"], ["class", "alert alert-danger", 4, "ngIf"], ["matInput", "", "tabindex", "1", "formControlName", "code", "id", "code", "type", "text", 1, "form-control"], ["matInput", "", "tabindex", "1", "formControlName", "catalog", "id", "catalog", "type", "text", 1, "form-control"], ["appearance", "fill", 1, "example-full-width"], ["matInput", "", "formControlName", "fecha", 3, "matDatepicker"], ["matSuffix", "", 3, "for"], ["touchUi", ""], ["picker", ""], ["matInput", "", "tabindex", "1", "formControlName", "id", "id", "id", "type", "text", "hidden", "", 1, "form-control"], ["mat-dialog-actions", ""], ["mat-button", "", "tabindex", "3", 3, "click"], ["mat-button", "", "tabindex", "-1", 3, "click"], ["matTooltip", "Tooltip!", 1, "type-tooltip-ne"], ["tabindex", "1", "formControlName", "business", "id", "business", 1, "example-select"], ["business", ""], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "alert", "alert-danger"], [4, "ngIf"]], template: function FilterValueComponent_Template(rf, ctx) { if (rf & 1) {
