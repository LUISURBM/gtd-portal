      ...
      <form [formGroup]="form">
        <div mat-dialog-content>
          ...
          <mat-form-field>
            ...
            >
              <div *ngIf="f.numeroDocumento.errors?.required">numero de documento is required.</div>
            </div>
          </mat-form-field>
          ...
          <mat-form-field>
            ...
            <div
              *ngIf="f.primerNombre.touched && f.primerNombre.invalid"
              class="alert alert-danger"
            >
              <div *ngIf="f.primerNombre.errors?.required">nombre is required.</div>
            </div>
          </mat-form-field>
          ...
          <mat-form-field>
            ...
            <div
              *ngIf="f.primerApellido.touched && f.primerApellido.invalid"
              class="alert alert-danger"
            >                
            <div *ngIf="f.primerApellido.errors?.required">Apellido is required.</div>
            </div>
          </mat-form-field>
