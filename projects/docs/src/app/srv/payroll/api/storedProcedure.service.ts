...
import { StoredProcedureServiceInterface } from './storedProcedure.serviceInterface';
...
export class StoredProcedureService implements StoredProcedureServiceInterface {
   ...
   */
  public exectuteProcedureUsingPOST(
    request: Request,
    observe?: 'body',
  ...
  public exectuteProcedureUsingPOST(
    ...
    if (request === null || request === undefined) {
      throw new Error(
        'Required parameter request was null or undefined when calling exectuteProcedureUsingPOST.'
      );
    }
    ...
    return this.httpClient.post<Response>(
      `${this.configuration.basePath}/documents/payrolls/procedure`,
      request,
      {
