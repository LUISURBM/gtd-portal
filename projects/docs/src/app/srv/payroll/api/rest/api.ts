...
export const APIS = [AnticiposService, AuxiliosService, BasicosService, BonificacionesService, BonosEPCTVService, CesantiasService, ComisionesService, CompensacionesService, DeduccionesService, DevengadosService, EmpleadoresService, FechasPagosService, FondosSPService, HorariosAdicionalesService, HuelgasLegalesService, IncapacidadesService, InformacionesGeneralesService, InvoicesService, LibranzasService, LicenciasService, LugaresGeneracionXMLService, NominasGeneralesService, NominasIndividualesService, NotasService, NumerosSecuenciaXMLService, OtrasDeduccionesService, OtrosConceptosService, PagosService, PagosTercerosService, PayrollsService, PeriodosService, PrimasService, ProveedoresXMLService, SaludPensionSindicatosService, SancionesService, TrabajadoresService, TransportesService, VacacionesCompensadasService, VacacionesComunesService];
