...
export class PayrollsService implements PayrollsServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public sendListUsingPOST5(list: ListNominaIndividualRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<any>>;
    public sendListUsingPOST5(list: ListNominaIndividualRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<any>>>;
    public sendListUsingPOST5(list: ListNominaIndividualRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<any>>>;
