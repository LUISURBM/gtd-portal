...
export class BasicosService implements BasicosServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listBasicoUsingGET1(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ResponseTListBasicoDto>;
    public listBasicoUsingGET1(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ResponseTListBasicoDto>>;
    public listBasicoUsingGET1(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ResponseTListBasicoDto>>;
    public listBasicoUsingGET1(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<ResponseTListBasicoDto>(`${this.configuration.basePath}/nomina-general/basicos/list`,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
