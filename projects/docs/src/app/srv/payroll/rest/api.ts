...
export const APIS = [
  ...
  CesantiasService,
  ComisionesService,
  CompensacionesService,
  DeduccionesService,
  DevengadosService,
  EmpleadoresService,
  FechasPagosService,
  FondosSPService,
  HorariosAdicionalesService,
  HuelgasLegalesService,
  ...
  PeriodosService,
  PrimasService,
  ProveedoresXMLService,
  SaludPensionSindicatosService,
  SancionesService,
  StoredProcedureService,
  TrabajadoresService,
  TransportesService,
  VacacionesCompensadasService,
  VacacionesComunesService,
];
