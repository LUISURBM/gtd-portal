...
import { PayrollsServiceInterface } from './payrolls.serviceInterface';
...
export class PayrollsService implements PayrollsServiceInterface {
  ...
  public payrollListUsingGET1(
    ...
    return this.httpClient.get<string>(
      `${this.configuration.basePath}/nomina-general/payrolls/list`,
      {
  ...
  public sendListUsingPOST4(
    ...
    if (list === null || list === undefined) {
      throw new Error(
        'Required parameter list was null or undefined when calling sendListUsingPOST4.'
      );
    }
    ...
    return this.httpClient.post<Array<any>>(
      `${this.configuration.basePath}/nomina-general/payrolls/send-list`,
      list,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
