...
export class LicenciaComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    this.dataSource$ = new BehaviorSubject<NgGtdDS>({
      datasource: new MatTableDataSource<Licencia>(licencias),
