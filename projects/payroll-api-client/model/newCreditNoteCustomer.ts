...
/**
 * Model that represents a Customer of the creditNote for SEND.
 */
export interface NewCreditNoteCustomer { 
    city?: string;
    country?: string;
    subDivision?: string;
    /**
     ...
     */
    neighborhood: NewCreditNoteCustomer.NeighborhoodEnum;
    /**
     * The store of the contact address.
     */
    store: NewCreditNoteCustomer.StoreEnum;
    /**
     * Final consumer
     */
     ...
     */
    businessName: NewCreditNoteCustomer.BusinessNameEnum;
    /**
     * The first name of the customer.
     */
    firstName: NewCreditNoteCustomer.FirstNameEnum;
    /**
     * The last name of the customer.
     */
    lastName: NewCreditNoteCustomer.LastNameEnum;
    /**
     ...
     */
    divCode: NewCreditNoteCustomer.DivCodeEnum;
    /**
     * The tax filer value.
     */
    taxFiler?: boolean;
...
export namespace NewCreditNoteCustomer {
