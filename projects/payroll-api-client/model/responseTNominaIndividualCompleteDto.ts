...
import { NominaIndividualCompleteDto } from './nominaIndividualCompleteDto';


export interface ResponseTNominaIndividualCompleteDto { 
    bodyDto?: NominaIndividualCompleteDto;
