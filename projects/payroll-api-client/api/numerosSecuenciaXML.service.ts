...
export class NumerosSecuenciaXMLService implements NumerosSecuenciaXMLServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listFindAllUsingGET17(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ResponseTListNumeroSecuenciaXmlDto>;
    public listFindAllUsingGET17(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ResponseTListNumeroSecuenciaXmlDto>>;
    public listFindAllUsingGET17(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ResponseTListNumeroSecuenciaXmlDto>>;
    public listFindAllUsingGET17(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
