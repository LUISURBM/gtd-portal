...
export class LugaresGeneracionXMLService implements LugaresGeneracionXMLServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listFindAllUsingGET14(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ResponseTListLugarGeneracionXmlDto>;
    public listFindAllUsingGET14(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ResponseTListLugarGeneracionXmlDto>>;
    public listFindAllUsingGET14(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ResponseTListLugarGeneracionXmlDto>>;
    public listFindAllUsingGET14(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
