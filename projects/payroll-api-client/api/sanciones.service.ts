...
export class SancionesService implements SancionesServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listFindAllUsingGET23(deduccionesId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ResponseTListSancionDto>;
    public listFindAllUsingGET23(deduccionesId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ResponseTListSancionDto>>;
    public listFindAllUsingGET23(deduccionesId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ResponseTListSancionDto>>;
    public listFindAllUsingGET23(deduccionesId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (deduccionesId === null || deduccionesId === undefined) {
            throw new Error('Required parameter deduccionesId was null or undefined when calling listFindAllUsingGET23.');
        }
