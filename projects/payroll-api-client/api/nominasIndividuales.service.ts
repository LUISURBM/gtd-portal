...
export class NominasIndividualesService implements NominasIndividualesServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listFindAllUsingGET16(businessSubscriptionId: string, nominaGeneralId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ResponseTListHashMapstringobject>;
    public listFindAllUsingGET16(businessSubscriptionId: string, nominaGeneralId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ResponseTListHashMapstringobject>>;
    public listFindAllUsingGET16(businessSubscriptionId: string, nominaGeneralId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ResponseTListHashMapstringobject>>;
    public listFindAllUsingGET16(businessSubscriptionId: string, nominaGeneralId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (businessSubscriptionId === null || businessSubscriptionId === undefined) {
            throw new Error('Required parameter businessSubscriptionId was null or undefined when calling listFindAllUsingGET16.');
        }
        if (nominaGeneralId === null || nominaGeneralId === undefined) {
            throw new Error('Required parameter nominaGeneralId was null or undefined when calling listFindAllUsingGET16.');
        }
